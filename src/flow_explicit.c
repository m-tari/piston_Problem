...
void flow_explicit(void)
{
	...
	_FLOAT *eps2r = bagF->eps2r;
	_FLOAT *eps4r = bagF->eps4r;
	_FLOAT *eps2l = bagF->eps2l;
	_FLOAT *eps4l = bagF->eps4l;

	_FLOAT *dw1r  = bagF->dw1r;
	_FLOAT *dw2r  = bagF->dw2r;
	_FLOAT *dw3r  = bagF->dw3r;
	_FLOAT *dw1l  = bagF->dw1l;
	_FLOAT *dw2l  = bagF->dw2l;
	_FLOAT *dw3l  = bagF->dw3l;
